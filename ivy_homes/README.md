...
Read the API documentation and list the assumptions it made.

Test authentication and request headers independently.

Test collection endpoints with small requests.

Test pagination using both documented and alternative parameters.

Test filters and sorting independently.

Test individual detail endpoints using IDs known to exist in collection responses.

Test favourites and analytics separately.

Extract the available datasets and compare counts and fields.

Use the observed behaviour to decide which frontend assumptions were safe.
...
Offset-based, effective limit 50
...
Use has_more while fetching

Listings sorting

Descending server sort unreliable
...
Some collection IDs return 404

Graceful detail fallback/error

Rentals

Collection/detail usable
